...
@implementation RNKeyPair

static const uint8_t publicKeyIdentifier[]		= "com.public.rnkeypari.temp";
static const uint8_t privateKeyIdentifier[]		= "com.private.rnkeypair.temp";
...
- (NSDictionary*) generateKeyPair:(NSUInteger)keySize {
    ...
    NSString* publicKey = [self X509FormattedPublicKey: (__bridge NSData *)publicKeyBits];
